...
<div class="container mt-5">
    @if ($user->role === 'student')
        <h1 class="mb-5" style="color: #1A3C65;">Courses you're enrolled in:</h1>
    @elseif ($user->role === 'teacher')
        <h1 class="mb-5" style="color: #1A3C65;">Courses you're teaching:</h1>
    @endif
            ...
            <div class="col-lg-4 mb-4">
                <div class="card shadow-sm h-100" style="border-left: 4px solid #1A3C65;">
                    <div class="card-body">
                        ...
                        <a href="{{ route('courses.show', $course->id) }}" class="btn btn-outline-primary btn-sm">View course profile</a>
                    </div>
                </div>
            </div>
            @endforeach
